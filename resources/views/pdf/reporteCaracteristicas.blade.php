...
<body style="font-family: 'Arial', sans-serif;">
    ...
    <header>
        <table style="margin-bottom: 20px" width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center; font-weight: bold">Reporte de Características</td>
            </tr>
    ...
    <div>
        <table width="100%" border="1" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
            <tr>
                <th colspan="6" style="padding: 5px 0 5px 0">Listado de características</th>
            </tr>
            <tr>
                <th>Código</th>
                <th>Nombre</th>
