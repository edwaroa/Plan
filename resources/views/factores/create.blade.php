    ...
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Crear Factor') }}</h6>
            </div>
            @if(session('estado'))
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('factores.store') }}" autocomplete="off" novalidate enctype="multipart/form-data">
                    ...
                    <div class="pl-lg-4">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="number" class="form-control @error('codigo') is-invalid @enderror" min="0" name="codigo" id="codigo" value="{{ old('codigo') }}" placeholder="Codigo del factor">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Nombre del Factor">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control area @error('descripcion') is-invalid @enderror" placeholder="Descripción del factor">{{ old('descripcion') }}</textarea>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    <label for="peso" class="form-control-label">{{ __('Peso del factor sobre el proyecto: ') }} <span class="text-success">{{ $peso_total }} Disponibles</span></label>
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <button type="submit" class="btn btn-primary">
                                        <span class="icon text-white-50">Crear Factor</span>
                                    </button>
                                </div>
                            </div>
                        </div>
