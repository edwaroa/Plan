    ...
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Editar Aspecto') }}</h6>
            </div>
            @if(session('estado'))
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('aspectos.update', ['aspecto' => $aspecto->id]) }}" autocomplete="off" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" class="form-control @error('codigo') is-invalid @enderror" min="0" name="codigo" id="codigo" value="{{ $aspecto->codigo }}" placeholder="Codigo del aspecto">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ $aspecto->nombre }}" placeholder="Nombre del aspecto">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control area @error('descripcion') is-invalid @enderror" placeholder="Descripción del aspecto">{{ $aspecto->descripcion }}</textarea>
                        ...
                        <div class="row justify-content-center">
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="id_caracteristica" id="id_caracteristica" class="form-control @error('id_caracteristica') is-invalid @enderror">
                                        ...
                                        @foreach ($caracteristicas as $caracteristica)
                                            <option value="{{ $caracteristica->id }}" {{ $aspecto->id_caracteristica == $caracteristica->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="number" step=".1" class="form-control @error('peso') is-invalid @enderror" min="0" name="peso" id="peso" value="{{ $aspecto->peso }}" placeholder="Peso del aspecto">
