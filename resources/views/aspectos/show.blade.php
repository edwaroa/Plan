            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-success text-center">
                    <div class="d-inline-block text-white text-lg mx-1">
                        <i class="fas fa-balance-scale-left text-lg"></i> Peso del aspecto
                    </div>
                </div>
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-lg-12 mt-2 p-0">
                            <h2 class="text-primary font-weight-bold mb-0">{{ $aspecto->peso }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8 order-lg-1">
            <div class="card shadow mb-4 p-3">
                <div class="mx-auto text-center col-md-10">
                    <h3 class="p-0 mb-5">{{ $aspecto->nombre }}</h3>
                </div>
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <div class="mb-3">
                            <h3 class="text-primary mb-2">Descripción</h3>
                            <p class="text-justify">{{ $aspecto->descripcion }}</p>
                        </div>
                    </div>
                    <div class="col-md-10 mx-auto">
                        <div class="row">   
                            <div class="mb-3 col-md-6">
                                <h3 class="text-primary mb-2">Característica</h3>
                                <p>{{ $aspecto->caracteristica->nombre }}</p>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="mx-auto col-md-10">
                        <div class="row my-3">
                            <div class="col">
                                <a href="{{ route('aspectos.edit', ['aspecto' => $aspecto->id]) }}" class="text-primary">¿Desea editar este aspecto?</a>
                            </div>
                        </div>
                    </div>
                </div>
