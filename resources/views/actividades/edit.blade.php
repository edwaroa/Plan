    ...
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Editar Actividad') }}</h6>
            </div>
            @if(session('estado'))
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('actividades.update', ['actividad' => $actividad->id]) }}" autocomplete="off" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ $actividad->nombre }}" placeholder="Nombre de la actividad">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control area @error('descripcion') is-invalid @enderror" placeholder="Descripción de la actividad">{{ $actividad->descripcion }}</textarea>
                        ...
                        <div class="row justify-content-center">
                                ...
                                <div class="form-group focused">
                                    ...
                                    <select name="id_indicador" id="id_indicador" class="form-control @error('id_indicador') is-invalid @enderror">
                                        ...
                                        @foreach ($indicadores as $indicador)
                                            <option value="{{ $indicador->id }}" {{ $actividad->id_indicador == $indicador->id ? 'selected' : '' }}>
                                                {{ $indicador->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="number" step=".1" class="form-control @error('peso') is-invalid @enderror" min="0" name="peso" id="peso" value="{{ $actividad->peso }}" placeholder="Peso de la actividad">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input class="form-control @error('fecha_inicio') is-invalid @enderror" name="fecha_inicio" type="date" id="fecha_inicio" value="{{ $actividad->fecha_inicio }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input class="form-control @error('tiempo_entrega') is-invalid @enderror" name="tiempo_entrega" type="date" id="tiempo_entrega" value="{{ $actividad->tiempo_entrega }}">
                                ...
                                <div class="form-group focused">
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        <div class="form-check-inline mr-5">
                                            ...
                                            @if (is_array($actividad_user) && in_array("$usuario->id", $actividad_user))
                                                checked
                                            @endif
