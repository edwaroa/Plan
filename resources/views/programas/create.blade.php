    ...
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Crear Programa') }}</h6>
            </div>
            @if(session('estado'))
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('programas.store') }}" autocomplete="off" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Nombre del Programa">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control area @error('descripcion') is-invalid @enderror" placeholder="Descripción del Programa">{{ old('descripcion') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <button type="submit" class="btn btn-primary">
                                        <span class="icon text-white-50">Crear Programa</span>
                                    </button>
                                </div>
                            </div>
                        </div>
