...
ciu_dep.forEach(ciudep => {
    console.log(ciudep.departamento);
})

select.addEventListener('change', function(){

    ciud.innerHTML = '<option value="" selected disabled>-- Seleccione una Opción --</option>';

    ciu_dep[this.value].ciudades.forEach(ciudad => {
